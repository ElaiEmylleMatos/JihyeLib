...
var validator = (function($){
    ...
    */
    message = {
        ...
        checked         : 'Marque o checkbox',
        empty           : 'Campo vazio',
        min             : 'Entrada muito curto',
        max             : 'Entrada muito longa',
        number_min      : 'Número muito pequeno',
        number_max      : 'Número muito alto',
        url             : 'URL inválido',
        number          : 'Não é um número',
        email           : 'Email inválido',
        email_repeat    : 'Email diferente',
        password_repeat : 'Senha diferente',
        repeat          : 'no match',
